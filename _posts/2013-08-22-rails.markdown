...
<%= collect_select(:tag, :category_id, Category.all, :id, :id, :name) %>
<%= grouped_collect_select(:tag, :categroy_id, Category.all, :tags, :id, :id, :name) %>
<%= grouped_collect_select(:product, :list_id, Tag.all, :lists, :id, :id, :name) %>
```
